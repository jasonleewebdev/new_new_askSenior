			...
			<div class="category">
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listAll.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listLife.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listBusiness.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listRecruitment.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listImprovement.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listInvestment.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listFoundation.ques'">
				...
				<div class="category-wrapper">
					<a class="category-card">
						<div class="category-content" onclick="location.href='${pageContext.request.contextPath }/question/listEtc.ques'">
