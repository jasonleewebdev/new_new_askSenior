...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newQuestionDetail.css" rel="stylesheet"/>
    <style>
        #logo{
            ...
            <div id="subnavigation_result_body">
                ...
                <div id="subnavigation_list">
                    <div id="subnavigation_list_title">
                        <!--<input type="checkbox" />-->
                        <span>질문 번호</span>
                        <input type="text" value="${questionOne.getQuestionNumber()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>작성자</span>
                        <input type="text" value="${questionOne.getMemberNumber()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>카테고리</span>
                        <input type="text" value="${questionOne.getQuestionCategory()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>제목</span>
                        <input type="text" value="${questionOne.getQuestionTitle()}"/>
                    </div>
                    
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>내용</span>
                        <input type="text" value="${questionOne.getQuestionContent()}"/>
                        
                    </div>
                    <div class="subnavigation_list_detail">
                        <!--<input type="checkbox" name="select_member"/>-->
                        <span>작성 일자</span>
                        <input type="text" value="${questionOne.getQuestionUpdatedDate()}"/>
                ...
                <div id="back_and_submit">
                    <button style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/questionList.admin'">목록으로</button>
                    <button type="submit" style="cursor:pointer" onclick="location.href='${pageContext.request.contextPath}/admin/questionRemove.admin?qbunho=${questionOne.getQuestionNumber()}'">삭제하기</button>
                </div>
