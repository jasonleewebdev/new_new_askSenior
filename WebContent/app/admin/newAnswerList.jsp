...
<head>
    ...
    <link href="${pageContext.request.contextPath}/assets/css/admin/newAnswerList.css" rel="stylesheet"/>
    <style>
        #logo{
                ...
                <div id="subnavigation_list">
                    ...
                    <c:choose>
                    	<c:when test="${not empty answerList and fn:length(answerList) > 0}">
                                          <c:forEach var="answerOne" items="${answerList}">
                                              <c:set var="gowhat" value="${answerOne.getAnswerNumber()}"/>
                                              
                                            <div class="subnavigation_list_detail" >
                                             <a class="subnavigation_list_detail" href="${pageContext.request.contextPath}/admin/answerDetail.admin?abunho=${gowhat}">
                                                <span><c:out value="${answerOne.getAnswerNumber()}"/></span>
                                                <span><c:out value="${answerOne.getQuestionNumber()}"/></span>
                                                <span><c:out value="${answerOne.getMemberNumber()}"/></span>
                                                <span><c:out value="${answerOne.getAnswerContent()}"/></span>
                                                <span><c:out value="${answerOne.getAnswerUpdatedDate()}"/></span>                                                                  
                                            </a> 
                                            </div> 
                   ...
                   <!--  <div class="subnavigation_list_detail">
                        ...
                        <span>1</span>
                        <span>jsp어렵지 않습니다</span>
                        <span>itking</span>
                        <span>2022-10-23</span>
                        <span>1</span>
                        <span>이 youtube 동영상에 설명이 잘 되어있습니다</span>
            ...
            <div id="page_action">
                ...
                <div id="page_arrow">
					...
					<c:when test="${prev}">  
						...
						<a style="width : 100px; color:black;"  href="${pageContext.request.contextPath}/admin/answerList.admin?page=${page - 1}">&lt;</a>
                  ...
                  <c:otherwise>
                    ...
                    <a style="width : 100px; color:black;" href="${pageContext.request.contextPath}/admin/answerList.admin?page=${page}">${page}</a> 
