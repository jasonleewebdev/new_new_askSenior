    ...
    <main>
        ...
        <section>
            ...
            <div class="page-nav-container">
                <div class="page-nav">
                <c:if test="${prev}">
					<button><a href="${pageContext.request.contextPath}/question/listRecruitment.ques?page=${startPage - 1}">&lt;</a></button>
				</c:if>
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
													<c:choose>
														<c:when test="${not (i eq page)}">
															<button>
															<a href="${pageContext.request.contextPath}/question/listRecruitment.ques?page=${i}">
																<c:out value="${i}"/>&nbsp;&nbsp;
															</a>
															</button>
														</c:when>
				...
				<c:if test="${next}">
							<a href="${pageContext.request.contextPath}/question/listRecruitment.ques?page=${endPage + 1}">&gt;</a>
				</c:if>
					<!--  
                    <button>1</button>
                    <button>2</button>
